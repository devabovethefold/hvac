    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 bg-brand-secondary text-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex w-full flex-col items-start justify-between border border-white/10 p-6 md:p-8">
            ...
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
                src="/images/hvac/hvac_customer_avatar2.png"
                alt="Sarah Martinez"
          ...
          <div className="flex w-full flex-col items-start justify-between border border-white/10 p-6 md:p-8">
            ...
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
                src="/images/hvac/hvac_customer_avatar1.png"
                alt="Tom Chen"
                className="mb-4 size-12 min-h-12 min-w-12 rounded-full object-cover md:mb-0 md:mr-4"
              />
              <div>
                <p className="font-semibold">Tom Chen</p>
                <p>Homeowner</p>
              </div>
            </div>
          </div>
          <div className="flex w-full flex-col items-start justify-between border border-white/10 p-6 md:p-8">
            ...
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
                src="/images/hvac/hvac_customer_avatar3.png"
                alt="Linda Rodriguez"
                className="mb-4 size-12 min-h-12 min-w-12 rounded-full object-cover md:mb-0 md:mr-4"
              />
              <div>
