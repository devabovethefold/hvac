          ...
          >
            ...
            <AnimatePresence>
              <motion.nav
                ...
                exit="close"
                transition={{ duration: 0.2 }}
                className="bg-brand-secondary text-white lg:absolute lg:z-50 lg:border lg:border-white/10 lg:p-2 lg:[--y-close:25%]"
              >
                <a
                  href="#"
                  className="block py-3 pl-[5%] text-md lg:px-4 lg:py-2 lg:text-base border-b border-white/5 last:border-0"
                >
                  About
                </a>
                <a
